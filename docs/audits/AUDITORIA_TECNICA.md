...
**Estado:** olas 0 y 1 y la parte 1 de la ola 2 desplegadas y verificadas en producción; parte 2 en preparación local.
...
| P1-05 · Carga de imágenes | Mitigado en producción; BotID en preparación | La parte 1 elimina `/api/upload` y Vercel Blob del flujo. BotID Basic ya está integrado localmente en la parte 2; faltan Preview y WAF para cerrar el hallazgo. |
...
- Pruebas, lint, tipos y build: aprobados. Falta verificar en Preview que OIDC esté disponible y que el envío real reciba los encabezados de BotID.
...
**Estado:** dividida en dos partes; parte 1 cerrada en producción con `7777871`, BotID de la parte 2 preparado localmente y WAF pendiente
