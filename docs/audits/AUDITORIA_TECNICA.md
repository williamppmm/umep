...
| P3-09 · Movimiento | Mitigado; excepción de producto aceptada | Splash y animaciones respetan movimiento reducido. El ticker realiza una vuelta finita de 20 segundos, el hero una de 10 segundos y los botones un pulso de 3 segundos; se reinician al volver a montar su ruta. Al superar cinco segundos sin control de pausa, el riesgo residual frente a WCAG 2.2.2 permanece documentado y no se declara cerrado. |
...
**Decisión de producto · 25 de agosto de 2026:** se conserva el movimiento como parte de la identidad visual, sin añadir un control visible. El ticker ejecuta una sola vuelta de 20 segundos en `/servicios`; los anillos y el pulso del hero ejecutan una sola secuencia de 10 segundos en `/`; y el pulso social dura 3 segundos. Cada secuencia vuelve a empezar cuando el visitante abandona la ruta y regresa. `prefers-reduced-motion: reduce` las desactiva por completo y el logo conserva su estado azul estático. Esta decisión elimina el movimiento perpetuo, pero no satisface por sí sola WCAG 2.2.2 para las secuencias mayores de cinco segundos; por ello P3-09 queda **mitigado con excepción aceptada**, no cerrado.
